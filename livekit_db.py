"""
Database module for logging LiveKit receptionist calls to Vercel Postgres.

Separate from db.py to use a different table name (livekit_receptionist_call_logs).
"""
...
def init_db():
    ...
    try:
        ...
        conn.commit()
        cur.close()
        logger.info("Database initialized - livekit_receptionist_call_logs table ready")
